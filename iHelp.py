...
def wish_user():
    ...
    fun_talk("I am iHelp, a voice assistant. Tell me how may I help you.")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
        ...
        elif 'open mozilla firefox' in query or 'open firefox' in query:
            ...
            os.startfile("C:\\Users\\91954\\AppData\\Local\\Microsoft"
                         "\\WindowsApps\\SpotifyAB.SpotifyMusic_zpdnekdrzrea0\\Spotify.exe")

        elif 'who are you' in query:
            fun_talk("I am iHelp, developed by Umesh Singh as a project.")

        elif 'what you want to do' in query:
            fun_talk("I want to help people to do certain tasks on their single voice command.")
            ...
            fun_talk("I am written in Python and I generally speak English(US).")

        elif 'send email' in query:

            def send_mail(receiver, subject, message):

                info_file = open("MyPA_ID.txt", "r")
                data_id = info_file.readline()
                info_file.close()

                info_fi = open("MyPA.txt", "r")
                data_pa = info_fi.readline()
                info_fi.close()

                server = smtplib.SMTP('smtp.gmail.com', 587)
                server.starttls()
                server.login(data_id, data_pa)
            ...
            email_list = {
                ...
                'Meenakshi': 'something13@gmail.com',
                'Singh': 'something12@gmail.com',
                'Abhay': 'something11@gmail.com'
            }

            def get_mail_info():
                fun_talk('To whom you want to send email')
                u_name = get_command()
                receiver = email_list[u_name]
                print(receiver)
                ...
                fun_talk('Hey ! Your email is sent Successfully.')
        ...
        elif 'exit p a' in query or 'by p a' in query or 'bye p a' in query:
            ...
            webbrowser.open("outlook.office365.com/mail/inbox")
            ...
            def send_whtmsg():
                ...
                if 'yes' in act_msg:
                    ...
                    pywhatkit.sendwhatmsg(check_recep, msg, hr, min+2, wait_time=20)
                    ...
                    print(hr)
                    print(min)
                    pywhatkit.sendwhatmsg(check_recep, msg, hr, min, wait_time=10)
                    print('Hey lazy person. Your message is sent successfully.')
            ...
            name_val = random.randint(1, 10000)
            sc.save(f'pa_ss{name_val}.png')
            ...
            fun_talk("I am fine, Thank you..")
            fun_talk("How are you, Sir")
            pa_qus = get_command()
            if 'good' in pa_qus or 'fine' in pa_qus or 'well' in pa_qus or 'happy' in pa_qus:
                fun_talk("Good to know that you are fine and happy.")
            else:
                fun_talk("Be strong now, because things will get better. "
            ...
            try:
                ...
                con_curr = cur.convert(src_cur, dest_cur, val_cur)
                print(f"{val_cur} {from_cur} contains {con_curr} {to_cur}")
                fun_talk(f"{val_cur} {from_cur} contains {con_curr} {to_cur}")
